    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/employees/*/deactivate").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/employees/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/tasks").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/tasks/*").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/tasks/*").hasRole("ADMIN")
                        .requestMatchers("/api/tasks/my").hasAnyRole("EMPLOYEE", "ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/tasks/*/status").hasAnyRole("EMPLOYEE", "ADMIN")
                        .requestMatchers("/api/dashboard/employee").hasAnyRole("EMPLOYEE", "ADMIN")
